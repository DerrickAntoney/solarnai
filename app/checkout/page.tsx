          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <select id="select-country-input-3" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500">
                ...
                <option value="UK">Elgeyo-Marakwet</option>
                <option value="UK">Embu</option>
                <option value="UK">Garissa</option>
                <option value="UK">Homa Bay</option>
                <option value="UK">Isiolo</option>
                <option value="UK">Kajiado</option>
                <option value="UK">Kakamega</option>
                <option value="UK">Kericho</option>
                <option value="UK">Kiambu</option>
                <option value="UK">Kilifi</option>
                <option value="UK">Kirinyaga</option>
                <option value="UK">Kisii</option>
                <option value="UK">Kisumu</option>
                <option value="UK">Kitui</option>
                <option value="UK">Kwale</option>
                <option value="UK">Laikipia</option>
                <option value="UK">Lamu</option>
                <option value="UK">Machakos</option>
                <option value="UK">Makueni</option>
                <option value="UK">Mandera</option>
                <option value="UK">Marsabit</option>
                <option value="UK">Meru</option>
                <option value="UK">Migori</option>
                <option value="UK">Mombasa</option>
                <option value="UK">Murang&#39a</option>
                <option value="UK">Nakuru</option>
                <option value="UK">Nandi</option>
                <option value="UK">Narok</option>
                <option value="UK">Nyamira</option>
                <option value="UK">Nyandarua</option>
                <option value="UK">Nyeri</option>
                <option value="UK">Samburu</option>
                <option value="UK">Siaya</option>
                <option value="UK">Taita-Taveta</option>
                <option value="UK">Tana River</option>
                <option value="UK">Tharaka-Nithi</option>
                <option value="UK">Trans Nzoia</option>
                <option value="UK">Turkana</option>
                <option value="UK">Uasin Gishu</option>
                <option value="UK">Vihiga</option>
                <option value="UK">Wajir</option>
                <option value="UK">West Pokot</option>
              </select>
            </div>
